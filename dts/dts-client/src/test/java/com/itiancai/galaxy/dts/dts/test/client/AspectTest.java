...
import com.itiancai.galaxy.dts.TestScalaController;
...
public class AspectTest  extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void successScalaFuture(){
        ...
        Assert.assertEquals(testScalaController.testSuccessActivity("name","1111111111","sssssssssssssss").get(),"success");
    }
    ...
    public void jsonScalaFuture(){
        testScalaController.set(testScalaController);
        Assert.assertEquals(testScalaController.testJsonActivity("name","1111111111","sssssssssssssss").get(),"success");;
    }
