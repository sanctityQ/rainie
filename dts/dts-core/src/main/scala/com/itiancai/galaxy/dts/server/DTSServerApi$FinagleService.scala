...
class DTSServerApi$FinagleService(
  ...
  addFunction("servicePath", { (iprot: TProtocol, seqid: Int) =>
    try {
      __stats_servicePath.RequestsCounter.incr()
      val args = ServicePath.Args.decode(iprot)
      iprot.readMessageEnd()
      (try {
        iface.servicePath(args.sysName, args.moduleName)
      } catch {
        case e: Exception => Future.exception(e)
      }).flatMap { value: String =>
        reply("servicePath", seqid, ServicePath.Result(success = Some(value)))
      }.rescue {
        case e: com.itiancai.galaxy.dts.server.ServiceNotFindException => {
          reply("servicePath", seqid, ServicePath.Result(e = Some(e)))
        }
      ...
      case e: TProtocolException => {
        iprot.readMessageEnd()
        exception("servicePath", seqid, TApplicationException.PROTOCOL_ERROR, e.getMessage)
      }
      case e: Exception => Future.exception(e)
    }
  })
