package com.itiancai.galaxy.http.internal.server
...
import com.itiancai.galaxy.conversions.string._
...
private[galaxy] trait BaseHttpServer extends TwitterServer {

  protected def defaultRainieHttpPort: String = ":8888"
  private val httpPortFlag = flag("http.port", defaultRainieHttpPort, "External HTTP server port")
